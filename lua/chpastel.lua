...
Group.new('LspDiagnosticsFloatingError',           c.Red,     g.syntax_cursor,  ul)
Group.new('LspDiagnosticsFloatingWarning',         c.Yellow,      g.syntax_cursor,  ul)
Group.new('LspDiagnosticsFloatingInformation',     c.green_fill,  g.syntax_cursor,  ul)
Group.new('LspDiagnosticsFloatingHint',            c.Green,       g.syntax_cursor,  ul)
