...
Group.new('Comment',        c.syntax_bg,      c.DarkYellow,       i)
Group.new('Constant',       c.syntax_bg,        c.DarkYellow,       no)
Group.new('String',         c.syntax_bg,        c.DarkYellow,       no)
Group.new('Character',      c.syntax_bg,        c.DarkYellow,       no)
Group.new('Number',         c.syntax_bg,   c.DarkYellow,       no)
Group.new('Boolean',        c.syntax_bg,   c.DarkYellow,       no)
Group.new('Float',          c.syntax_bg,   c.DarkYellow,       no)
Group.new('Identifier',     c.syntax_bg,      c.DarkYellow,       no)
Group.new('Function',       c.syntax_bg,         c.DarkYellow,       no)
Group.new('Statement',      c.syntax_bg,      c.DarkYellow,       no)
Group.new('Conditional',    c.syntax_bg,      c.DarkYellow,       no)
Group.new('Repeat',         c.syntax_bg,      c.DarkYellow,       no)
Group.new('Label',          c.syntax_bg,      c.DarkYellow,       no)
Group.new('Operator',       c.syntax_bg,         c.DarkYellow,       no)
Group.new('Keyword',        c.syntax_bg,      c.DarkYellow,       no)
Group.new('Exception',      c.syntax_bg,      c.DarkYellow,       no)
Group.new('PreProc',        c.syntax_bg,       c.DarkYellow,       no)
Group.new('Include',        c.syntax_bg,         c.DarkYellow,       no)
Group.new('Define',         c.syntax_bg,      c.DarkYellow,       no)
Group.new('Macro',          c.syntax_bg,      c.DarkYellow,       no)
Group.new('PreCondit',      c.syntax_bg,       c.DarkYellow,       no)
Group.new('Type',           c.syntax_bg,       c.DarkYellow,       no)
Group.new('StorageClass',   c.syntax_bg,       c.DarkYellow,       no)
Group.new('Structure',      c.syntax_bg,       c.DarkYellow,       no)
Group.new('Typedef',        c.syntax_bg,       c.DarkYellow,       no)
Group.new('Special',        c.syntax_bg,         c.DarkYellow,       no)
Group.new('SpecialChar',    c.syntax_bg,         c.DarkYellow,       no)
Group.new('Tag',            c.syntax_bg,         c.DarkYellow,       no)
Group.new('Delimiter',      c.syntax_bg,         c.DarkYellow,       no)
Group.new('SpecialComment', c.syntax_bg,      c.DarkYellow,       no)
Group.new('Debug',          c.syntax_bg,         c.DarkYellow,       no)
Group.new('Underlined',     c.syntax_bg,         c.DarkYellow,       ul)
Group.new('Ignore',         c.syntax_bg,         c.DarkYellow,       no)
Group.new('Error',          c.syntax_bg,      c.green_fill, b)
Group.new('Todo',           c.syntax_bg,      c.green_fill, no)
