...
Group.new("PMenu", colors.chpastel_bg, colors.pmenu, nil)
Group.new("PMenuSel", colors.black, colors.yellow:dark():dark(), nil)
Group.new("PMenuSBar", colors.yellow, colors.pmenu, nil)
Group.new("PMenuThumb", colors.yellow, colors.yellow:dark():dark(), nil)
