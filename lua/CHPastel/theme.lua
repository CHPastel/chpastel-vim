...
Group.new("PMenu", colors.yellow, colors.green:dark(), nil)
Group.new("PMenuSel", colors.black, colors.yellow, nil)
Group.new("PMenuSBar", nil, colors.chpastel_bg.dark(), nil)
Group.new("PMenuThumb", nil, colors.chpastel_bg.light(), nil)
