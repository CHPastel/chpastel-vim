...
Group.new("DiagnosticUnderlineHint", colors.purple, nil, styles.underline)
...
Group.new("LspDiagnosticsDefaultHint", colors.purple, nil, nil)
...
Group.new("LspDiagnosticsHint", colors.purple, nil, nil)
...
Group.new("LspDiagnosticsVirtualTextHint", colors.purple, nil, nil)
...
Group.new("LspDiagnosticsHintUnderline", colors.purple, nil, styles.underline)
